...
namespace WFA_Chess_Game
{
    public partial class Form1 : Form
    {
        ...
        CustomCTRL_PictureBox _KingWhite = null;
        CustomCTRL_PictureBox _KingBlack = null;
        ...
        CustomCTRL_PictureBox.enCheesPieces _CurrentPiescesName;
        CustomCTRL_PictureBox.enCheesPieces _PlayerChosenPiece = CustomCTRL_PictureBox.enCheesPieces.Empty;
        int moveNumber = 1;
        Position _Sb_Pos;
        //Type Pieces
        ...
        private void CheesGame_EventHandler(object sender, CheesGameEventArgs e)
        {
            ...
            if (_CurrentTurn==enCheesPiecesType.Empty)
                return;
            if (_PlayerWhite_Win||_PlayerBlack_Win)
                return;
        ...
        private void _ResetChessBoard()
        {
            for (int row = 0; row<_Rows; row++)
            {
                ...
                for (int col = 0; col<_Cols; col++)
                {
                    ...
                    {
                        gbGrid.Controls.Remove(_PictureBoxGrid[row, col]);
                        _PictureBoxGrid[row, col].Dispose();
                    }
                }
            }
        }
            ...
            for (int row = 0; row<_Rows; row++)
            {
                ...
                for (int col = 0; col<_Cols; col++)
                {
                   ...
                   // this.Controls.Add(NewPictureBox);
                    ...
                    _PictureBoxGrid[row, col].Click +=(s, e) =>
                    {
                        RaiseCheesGame(this, new CheesGameEventArgs(NewPictureBox));
                    };
        ...
        private void _HandelAllPieceRooK(int rowReal, int col, int rowFrom, CustomCTRL_PictureBox NewPictureBox, Image image, CustomCTRL_PictureBox.enCheesPiecesType Type)
        {
        ...
        private void _HandelAllPieceBishop(int rowReal, int col, int rowFrom, CustomCTRL_PictureBox NewPictureBox, Image image, CustomCTRL_PictureBox.enCheesPiecesType Type)
        {
        ...
        private void _HandelAllPieceKnight(int rowReal, int col, int rowFrom, CustomCTRL_PictureBox NewPictureBox, Image image, CustomCTRL_PictureBox.enCheesPiecesType Type)
        {
        ...
        private void _HandelAllPieceKing(int rowReal, int col, int rowFrom, CustomCTRL_PictureBox NewPictureBox, Image image, CustomCTRL_PictureBox.enCheesPiecesType Type)
        {
        ...
        private void _HandelAllPieceQueen(int rowReal, int col, int rowFrom, CustomCTRL_PictureBox NewPictureBox, Image image, CustomCTRL_PictureBox.enCheesPiecesType Type)
        {
        ...
        private void _HandelAllPiecePawn(int rowReal, int col, int rowFrom, CustomCTRL_PictureBox NewPictureBox, Image image, CustomCTRL_PictureBox.enCheesPiecesType Type)
        {
            if (rowReal == rowFrom&&(col>=0||col<=7))
            {
        ...
        private void _HandelAllPieceEmpty(CustomCTRL_PictureBox NewPictureBox)
        {
            NewPictureBox._PieceEmpty=new clsPieceEmpty(NewPictureBox.IdRow, NewPictureBox.IdCol);
            NewPictureBox._PieceEmpty.CurrentCTRL=NewPictureBox;
